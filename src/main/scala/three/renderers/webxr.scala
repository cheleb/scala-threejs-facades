...
trait XR extends EventTarget:
  def requestSession(
      mode: XRSessionMode,
      options: js.UndefOr[XRSessionInit] = js.undefined
  ): js.Promise[XRSession] = js.native
...
class XRWebGLLayer extends js.Object:
  def this(
      ...
      options: js.UndefOr[XRWebGLLayerInit] = js.undefined
  ) = this()
...
class XRRigidTransform extends js.Object:
  def this(matrix: Float32Array | DOMPointInit, direction: js.UndefOr[DOMPointInit] = js.undefined) =
    this()
...
class XRRay extends js.Object:
  def this(
      ...
      direction: js.UndefOr[XRRayDirectionInit] = js.undefined
  ) = this()
