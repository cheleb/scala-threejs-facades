...
class WebGLRenderList extends js.Object:
  ...
  def sort(
      opaqueSort: js.Function2[js.Any, js.Any, Double],
      transparentSort: js.Function2[js.Any, js.Any, Double]
  ): Unit = js.native
...
class WebGLState extends js.Object:
  ...
  def setBlending(
      blending: Blending,
      blendEquation: js.UndefOr[BlendingEquation] = js.undefined,
      blendSrc: js.UndefOr[BlendingSrcFactor] = js.undefined,
      blendDst: js.UndefOr[BlendingDstFactor] = js.undefined,
      blendEquationAlpha: js.UndefOr[BlendingEquation] = js.undefined,
      blendSrcAlpha: js.UndefOr[BlendingSrcFactor] = js.undefined,
      blendDstAlpha: js.UndefOr[BlendingDstFactor] = js.undefined,
...
class WebGLCapabilities extends js.Object:
  def this(gl: WebGLRenderingContext, extensions: js.Any, parameters: WebGLCapabilitiesParameters) =
    this()
...
class WebGLAttributes extends js.Object:
  def this(gl: WebGLRenderingContext | WebGLRenderingContext, capabilities: WebGLCapabilities) = this()
  ...
  def update(attribute: BufferAttribute | InterleavedBufferAttribute, bufferType: Double): Unit =
    js.native
...
class WebGLUniforms extends js.Object:
  ...
  def setValue(gl: WebGLRenderingContext, name: String, value: js.Any, textures: WebGLTextures): Unit =
    js.native
